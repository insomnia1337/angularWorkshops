export class Api {
    ...
    static GAME_END_POINT = 'ws://game.debugger.pl';
    static GAME_GET_USER_END_POINT = '//game.debugger.pl/get-user';
    static GAME_REGISTER_USER_END_POINT = '//game.debugger.pl/register';
}
